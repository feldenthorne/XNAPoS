...
{
    const spirit_namespace::int_parser < boost::int64_t >  int64_t_p  = spirit_namespace::int_parser < boost::int64_t  >();
    ...
    public:
        ...
        public:
            ...
            definition( const Json_grammer& self )
            {
                ...
                typedef boost::function< void( boost::uint64_t )      > Uint64_t_action;
